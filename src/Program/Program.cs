...
namespace Program
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            firstHandler =
                new StartHandler(Bot, new RegisterHandler(new CreateMatchHandler(new SearchMatchHandler(new HeatShipHandler(new HeatWaterHandler( new SetShipsPositionHandler(Bot, new ConversationHandler(Bot, new BattleHandler(Bot,new AttackHandler(Bot,null))))))))));
