...
namespace Program
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            firstHandler =
                new StartHandler(Bot, new RegisterHandler(new ConversationHandler(Bot, new CreateMatchHandler(new SearchMatchHandler(new SetShipsPositionHandler(Bot, null))))));
